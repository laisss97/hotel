...
<body>
	...
	<div class="quartos">
		...
		<img src="view/icon/quarto1.jpg"class="img-rounded" alt="quarto1"  width=60%; height=70%;>
		<div class="descricao"><strong>Quarto Simplex:</strong> cama king-size, ar-condicionado, wi-fi, tv e decoração em tons quentes.</div>

		<img src="view/icon/quarto2.jpg" class="img-rounded" alt="quarto2" width=60%; height=60%;>
		...
		<img src="view/icon/quarto3.jpg" class="img-rounded" alt="quarto3" width=60%; height=60%;>
		...
		<img src="view/icon/quarto4.jpg" class="img-rounded" alt="quarto4" width=60%; height=60%;>
