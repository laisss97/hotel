...
<body>
	...
	<div class="servicos">
		...
		<img src="view/icon/recepcao.jpg" class="img-rounded" width="500" height="450" alt="recepcao">
		<div class="descricao">
			O hóspede ao chegar no Hotel Palácios encontrará um ambiente de requinte e acolhedor.
			</div>

		<img src="view/icon/funcionarios.jpg" class="img-rounded" width="500" height="450" alt="funcionarios recepção">
		<div class="descricao">
			Nosso funcionários são altamente capacitados para prestar o melhor atendimento.
		</div>

		<img src="view/icon/camareira.jpg" class="img-rounded" width="500" height="450" alt="camareira">
		<div class="descricao">
			Possuímos uma equipe encarregada da organização do ambiente para a melhor comodidade para os hóspedes.
			
		</div>

		<img src="view/icon/cafe_da_manha.jpg" class="img-rounded" width="500" height="450" alt="café da manhã">
		<div class="descricao">
			Temos o melhor café colonial da região.</p>
		</div>

		<img src="view/icon/cafe_da_manha2.jpg" class="img-rounded" width="500" height="450" alt="tcafé da manhã ">
		<div class="descricao">
		...
		<img src="view/icon/piscina.jpg" class="img-rounded" width="500" height="450" alt="piscina">
		<div class="descricao">
			Nossa piscina está disponível durante 24horas, contando com salva-vidas em tempo integral e aquecimento.
		</div>

		<img src="view/icon/spa.jpg" class="img-rounded" width="500" height="450" alt="spa">
		<div class="descricao">Possuímos um spa com profisionais para ajudar no relaxamento dos hóspedes.</div>

		<img src="view/icon/piscina2.jpg" class="img-rounded" width="500" height="450" alt="piscina spa">
		...
		<img src="view/icon/restaurante.jpg" class="img-rounded" width="500" height="450" alt="salão de festas">
		<div class="descricao">O Salão Gold é o ambiente perfeito para grandes celebrações.</div>

		<img src="view/icon/salao_de_festas.jpg" class="img-rounded" width="500" height="450" alt="salão de festas 2">
		<div class="descricao">O Salão Silver é destinado para eventos profissionais.</div>

		<img src="view/icon/academia.jpg" class="img-rounded" width="500" height="450" alt="academia">
		...
		<img src="view/icon/jardim.jpg" class="img-rounded" width="500" height="450" alt="jardim">
